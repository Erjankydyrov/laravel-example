...
@section('main')
    ...
    <form class="edit-product-form" method="post" action="{{ route('products.update', $product->id) }}"
        ...
        <div class="edit-form-group">
            ...
            <img id="product-preview-edit" src="{{ asset('images/products/' . $product->image) }}"
                alt="product preview edit">
        </div>
